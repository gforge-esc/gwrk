...
- Run `gwrk define tests <feature>` to generate RED test files
...
- ❌ Introducing commands without `[exit:N | Xs]` signal wrapper (ADR-004)
- ❌ Assuming SQLite access in discovery commands (TC-004 in agent-native spec)

...
export function banner(command, fields) {
    const ts = timeStamp();
...
export function success(command, durationS, runId, logFile) {
    console.log("");
...
export function fail(command, exitCode, durationS, runId, logFile) {
    console.error("");
...
export function dryRun(command) {

 ...
 */
export function getDiffStats(repoPath, ref) {
    try {
        const stdout = execFileSync("git", ["diff", "--shortstat", ref], { cwd: repoPath, encoding: "utf-8", stdio: ["ignore", "pipe", "pipe"] });
 ...
 */
export async function isDirty(repoPath) {
    try {
 ...
 */
export async function createBranch(repoPath, branchName, baseBranch = "develop") {
 ...
 */
export async function syncBranch(repoPath, targetBranch = "develop") {
 ...
 */
export function isWorkingTreeClean(repoPath) {
    try {
        const stdout = execFileSync("git", ["status", "--porcelain"], {
            cwd: repoPath,
            encoding: "utf-8",
 ...
 */
export function commitFiles(repoPath, files, message) {
    try {
        // Stage files
 ...
 */
export function gitPush(repoPath, remote = "origin") {
 ...
 */
export function deleteRemoteBranch(repoPath, branch, remote = "origin") {
    try {

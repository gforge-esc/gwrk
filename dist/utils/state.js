...
export function saveTaskState(featureDir, state) {
...
export function markTaskComplete(state, taskId) {
...
export function listTasks(state) {
    return state.phases.flatMap((phase) => phase.tasks);
}
export function nextTask(state, phaseId) {

...
pnpm vitest run src/commands/plan.test.ts --reporter=verbose || { echo "FAIL: T037 — Phase 6 plan tests failed" >&2; exit 1; }
echo "PASS: T037 — Phase 6 test strategy complete"